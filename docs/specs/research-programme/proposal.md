...
- **Success criterion.** Bands fixed in T03; defaults lift within 3 %, drag within 15 %, rotor thrust coefficient within 5 %, GCI ≤ 2 % on the gated quantity; model-to-model differences reported.
